...
#define MQTTClient_connectOptions_initializer { {'M', 'Q', 'T', 'C'}, 4, 60, 1, 1, NULL, NULL, NULL, 1, 1, NULL, 0, NULL, 0}
...
DLLExport void MQTTClient_init();
DLLExport void MQTTClient_unInit();
DLLExport void MQTTClient_Suspend();
DLLExport void MQTTClient_Resume();
DLLExport void MQTTClient_run();
#endif
#ifdef __cplusplus
     }
#endif
...
int main(int argc, char* argv[])
{
  ...
  * @endcond
  */
  #define MQTT_SAFE_FREE(x) do { if ((x) != NULL) {free(x); x=NULL;} } while(0)